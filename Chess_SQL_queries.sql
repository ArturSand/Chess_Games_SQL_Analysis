...
--  Which player won the most amount of games?
...
-- I have created first a table to have a overview of higher_rank_winners
...
-- then calcualted the amount of games won by higher ranked player for white and black.

select 
	winner
	,(select COUNT(game_id) from higher_rank_winner)													as total_games
	,COUNT(game_id) 																					as games_won_by_white
...
select 
	winner
	,(select COUNT(game_id) from higher_rank_winner)													as total_games
	,COUNT(game_id)																						as games_won_by_black
